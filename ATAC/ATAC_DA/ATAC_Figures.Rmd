...
# Read in gr files for TSS (.gr files were made in "ATAC_QC_COUNTS_FINAL.Rmd")
tss <- readRDS(file = "../ATAC_DA/../ATAC_QC_Counts/tss.RDS")

# Unlist RDS object
gr.files <- unlist(tss[[3]])
`PW1_pax6_Whole-Tail_peaks.gr` <- tss[[1]]
`WW1_WT_Whole-Tail_peaks.gr` <- tss[[2]]
...
# plot Pax TSS
dist_hist(get(gr.files[1]), xmin = -20000, xmax = 20000, Title = gr.files[1])

# plot Whole tail TSs
dist_hist(get(gr.files[2]), xmin = -20000, xmax = 20000, Title = gr.files[2])

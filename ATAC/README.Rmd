...
```{r set up, cache=FALSE, warning=FALSE, message=FALSE, echo=FALSE}
...
# setwd
setwd("~/Desktop/pax6 paper/Final Markdowns/ATAC/")
...
# read in DA tables
paxVall_agg <- read.table("ATAC_DA/outs/DA_paxVall_ALL.txt", header = TRUE, sep = "\t", row.names = 1) # paxVall aggregate
paxVall <- read.table("ATAC_DA/outs/DA_paxVall.txt", header = TRUE, sep = "\t", row.names = 1) # paxVall aggregate
timepoints <- read.table("ATAC_DA/outs/DA_timepoints.txt", header = TRUE, sep = "\t", row.names = 1) # between timepoints within one condition

# Read in log counts
log.counts.paxVall <- as.matrix(read.table("ATAC_DA/outs/log.counts_paxVall_aggregate.txt", header = TRUE, sep = "\t", row.names = 1)) # log counts for paxVall aggregate
log.counts.timepoints <- as.matrix(read.table("ATAC_DA/outs/log.counts_timepoints.txt", header = TRUE, sep = "\t", row.names = 1)) # log counts for timepoints
...
tss <- readRDS(file = "ATAC_QC_Counts/tss.RDS")
...
# write out table
write.table(GO_PAX_use, "~/Desktop/pax6 paper/Final Markdowns/ATAC/ATAC_DA/outs_figures/GO_PAX_use.txt")
...
revi_tree_24hpa <- read.csv("~/Desktop/pax6 paper/Final Markdowns/ATAC/ATAC_DA/outs_figures/REVIGO_treemap_24hpa_091319.csv", header = 1)
...
# Read in .csv
revi_72hpa <- read.csv("ATAC_DA/outs_figures/revigo_72hpa.csv") # .csv
...
# Read in .csv
revi_72hpa <- read.csv("ATAC_DA/outs_figures/revigo_72hpa_tiny.csv") # .csv
revi_72hpa <- revi_72hpa[-1*grep(revi_72hpa$plot_X, pattern ="null"),] # remove nested GO terms
revi_72hpa$log10.p.value <- -1*revi_72hpa$log10.p.value
# order for barplot
revi_72hpa <- revi_72hpa[order(-revi_72hpa$log10.p.value),]
...
revi_tree_72hpa <- read.csv("~/Desktop/pax6 paper/Final Markdowns/ATAC/ATAC_DA/outs_figures/REVIGO_treemap_72hpa_091319.csv", header = 1)
...
```{r grn tables, warning=FALSE, message=FALSE, echo=FALSE}
...
```{r pbx3 and meis1, warning=FALSE, message=FALSE, echo=FALSE}
...
### pbx3 targets 1
```{r pbx3 targets 1, warning=FALSE, message=FALSE, echo=FALSE}
...
# DT::datatable(GO_pbx6_terms, caption = "pbx3 6hpa go")
# 
...
# DT::datatable(GO_pbx24_terms, caption = "pbx3 24hpa go")
# 
...
# DT::datatable(GO_pbx72_terms, caption = "pbx3 72hpa go")
# 
...
### meis1 targets
```{r meis targets, warning=FALSE, message=FALSE, echo=FALSE}
...
# DT::datatable(GO_meis6_terms, caption = "meis 6hpa go")
...
# DT::datatable(GO_meis24_terms, caption = "meis 24hpa go")
...
# DT::datatable(GO_meis72_terms, caption = "meis 72hpa go")

...
```{r flowjo output 1, cache=TRUE, warning=FALSE, message=FALSE, echo=FALSE}
...
### Subset table
```{r flowjo output subset, cache=TRUE, warning=FALSE, message=FALSE, echo=FALSE}
...
### Plot table
```{r flowjo output  plot, cache=TRUE, warning=FALSE, message=FALSE, echo=FALSE}

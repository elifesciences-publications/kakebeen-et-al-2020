...
# order clusters
pax.combined$AK_Names <- factor(pax.combined$AK_Names, levels = c("Spinal Cord Progenitor", "Differentiating Neuron", "Interneuron", "Vulnerable Motor Neuron", "Motor Neuron (Leptin+)", "Motor Neuron", "Notocord", "Mesenchyme", "Myotome", "Scleretome", "Sattelite Cells/Differentiating Myocyte", "Dermomyotome", "Skeletal Muscle", "Bipotent Progenitor", "Small Secretory Cell 1", "Small Secretory Cell 2", "ROCs", "Goblet Cell", "Other 1", "Other 2"))
...
# # Save out all cells
# saveRDS(pax.neural, "pax.neural_FINAL.RDS") # save 4 Oct 2019 (remove outliers)

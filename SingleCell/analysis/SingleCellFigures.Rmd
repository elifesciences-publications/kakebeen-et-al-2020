...
```{r scrnaseq figure set up, cache=FALSE}
# load packages
library(Seurat)
...
### Set up data table
```{r 4d, cache=TRUE, warning=FALSE, message=FALSE, echo=FALSE}
...
### Pie Charts
```{r uninjured cell proportions, cache=TRUE, warning=FALSE, message=FALSE, echo=FALSE}
...
### UMAPS
```{r uninjured cell proportions 2, cache=TRUE, warning=FALSE, message=FALSE, echo=FALSE}
...
```{r three state pie, cache=TRUE, warning=FALSE, message=FALSE, echo=FALSE}
...
### Table set up
```{r 4e.1, cache=TRUE, warning=FALSE, message=FALSE, echo=FALSE}
...
# View table
datatable(plot.table, caption = "Cell Cycle proportions")

```

### Pie Charts
```{r 4e.2, cache=TRUE, warning=FALSE, message=FALSE, echo=FALSE}
...
### UMAP
```{r 4e.3 charts, cache=TRUE, warning=FALSE, message=FALSE, echo=FALSE}
...
```{r 5d, cache=TRUE, warning=FALSE, message=FALSE, echo=FALSE}

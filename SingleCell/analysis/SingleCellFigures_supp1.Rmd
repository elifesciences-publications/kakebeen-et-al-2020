...
FeaturePlot(pax.all, features = c("sox2", "neurog1", "neurod1", "elavl4"),  order = TRUE, cols = c("dodgerblue3", "yellow", "forestgreen"))+ NoAxes()+NoLegend()
...
# plot neural markers
FeaturePlot(pax.all, features = c("meis1", "pbx3"),  order = TRUE, cols = c("dodgerblue3", "yellow", "forestgreen"))+ NoAxes()+NoLegend()
